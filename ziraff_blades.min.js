!function(){"use strict";var e=angular.module("ziraff_blades",[]);function a(i,n,r,o,e){return i.remoteAPI=i.remoteAPI||app_configuration.app_config.api_services.analytics,{load_blade_sets:function(){var e=o.id||o.Id||null,a=null;a="client_accounts"===r.current.data.permissionKey&&"leads"==o.isFrom?"client_leads":r.current.data.permissionKey;return n.get(i.remoteAPI+"api/blade/getbladetypes?permissionKey="+a+"&&id="+e)},load_bldes_data:function(e,a){var t=null;t="client_accounts"===r.current.data.permissionKey&&"leads"==o.isFrom?"client_leads":r.current.data.permissionKey;var l={CompanyId:i.rootId,ModuleDetailId:window.sessionStorage.getItem("ModuleDetailId"),PermissionKey:t,Role:"null",Id:o.id||o.Id||"null",BladeType:e,FilterType:a||"null"};return n.post(i.remoteAPI+"api/blade/GetBladeDetails",l)}}}e.factory("bldesService",a),a.$inject=["ziraffBladesConfiguration","$http","$state","$stateParams","serviceConfig"],e.value("ziraffBladesConfiguration",{rootId:null,role:null,userName:null,remoteAPI:null})}();
